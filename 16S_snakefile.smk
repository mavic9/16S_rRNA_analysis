...
thresh = int(input("Set a threshold for for filtration OTU frequency: "))
...
#variable set
trim_path = '/opt/Trimmomatic-0.39/trimmomatic-0.39.jar'
Adapters = '/opt/Trimmomatic-0.39/adapters/All_adapters.fa'
...
rule dada_1:
    ...
    shell:
        'Rscript DADA2_part_1.R {PWD} {thresh} &> dada_1.log'
...
rule mmseq_part_1:
    ...
    shell:
        'bash mmseq_clustering.sh {PWD} &> mmseq_part_1.log'
...
rule mmseq_part_2:
    ...
    shell:
        'python3 mmseq2_clustering.py {PWD} &> mmseq_part_2.log'
...
rule dada_2:
    ...
    shell:
        'Rscript DADA2_part_2.R {PWD} &> dada_2.log'
